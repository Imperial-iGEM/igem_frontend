...
export default function SpecCardLabwareEXP(props) {
  ...
  const [error_inputPip1,setError_inputPip1] = React.useState(false)
            ...
            <div>
              <form className={classes.root} noValidate autoComplete="off">
                ...
                <CardActions>
                  <FormGroup row>
                    <FormControlLabel
                      control={<Checkbox checked={props.stateUseThermocycler.checkedA} onChange={props.handleChangeUseThermocycler} name="checkedA" />}
